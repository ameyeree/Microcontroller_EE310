...
FINAL_IMAGE=${DISTDIR}/7segmentpractice.${IMAGE_TYPE}.${OUTPUT_SUFFIX}
else
...
SOURCEFILES_QUOTED_IF_SPACED=7seg.asm

# Object Files Quoted if spaced
OBJECTFILES_QUOTED_IF_SPACED=${OBJECTDIR}/7seg.o
POSSIBLE_DEPFILES=${OBJECTDIR}/7seg.o.d

# Object Files
OBJECTFILES=${OBJECTDIR}/7seg.o

# Source Files
SOURCEFILES=7seg.asm
...
ifneq ($(INFORMATION_MESSAGE), )
	...
	${MAKE}  -f nbproject/Makefile-default.mk ${DISTDIR}/7segmentpractice.${IMAGE_TYPE}.${OUTPUT_SUFFIX}

MP_PROCESSOR_OPTION=PIC18F47K42
FINAL_IMAGE_NAME_MINUS_EXTENSION=${DISTDIR}/7segmentpractice.${IMAGE_TYPE}
# ------------------------------------------------------------------------------------
# Rules for buildStep: pic-as-assembler
ifeq ($(TYPE_IMAGE), DEBUG_RUN)
${OBJECTDIR}/7seg.o: 7seg.asm  nbproject/Makefile-${CND_CONF}.mk 
	@${MKDIR} "${OBJECTDIR}" 
	@${RM} ${OBJECTDIR}/7seg.o 
...
ifeq ($(TYPE_IMAGE), DEBUG_RUN)
${DISTDIR}/7segmentpractice.${IMAGE_TYPE}.${OUTPUT_SUFFIX}: ${OBJECTFILES}  nbproject/Makefile-${CND_CONF}.mk    
	@${MKDIR} ${DISTDIR} 
	${MP_LD} -mcpu=PIC18F47K42 ${OBJECTFILES_QUOTED_IF_SPACED} \
	-o ${DISTDIR}/7segmentpractice.${IMAGE_TYPE}.${OUTPUT_SUFFIX} \
