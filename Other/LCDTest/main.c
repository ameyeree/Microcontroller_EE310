...
{       
    ...
    LCD_String_xy(2,0,"Slechta");   /*Display string at location(row,location). */
                                   /* This function passes string to display */    
...
//void LCD_String_xy(char ,char ,const char*);
//void MSdelay(unsigned int );
//void setCursor(char col, char line){
//    if(line ==1){
...
//{
//    PORTD = data;            /* Send data to PORT as a command for LCD */   
