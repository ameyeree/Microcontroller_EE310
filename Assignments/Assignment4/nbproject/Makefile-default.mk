...
FINAL_IMAGE=${DISTDIR}/Assignment4.${IMAGE_TYPE}.${OUTPUT_SUFFIX}
else
...
ifneq ($(INFORMATION_MESSAGE), )
	...
	${MAKE}  -f nbproject/Makefile-default.mk ${DISTDIR}/Assignment4.${IMAGE_TYPE}.${OUTPUT_SUFFIX}

MP_PROCESSOR_OPTION=PIC18F46K42
FINAL_IMAGE_NAME_MINUS_EXTENSION=${DISTDIR}/Assignment4.${IMAGE_TYPE}
# ------------------------------------------------------------------------------------
...
ifeq ($(TYPE_IMAGE), DEBUG_RUN)
${DISTDIR}/Assignment4.${IMAGE_TYPE}.${OUTPUT_SUFFIX}: ${OBJECTFILES}  nbproject/Makefile-${CND_CONF}.mk    
	@${MKDIR} ${DISTDIR} 
	${MP_LD} -mcpu=PIC18F46K42 ${OBJECTFILES_QUOTED_IF_SPACED} \
	-o ${DISTDIR}/Assignment4.${IMAGE_TYPE}.${OUTPUT_SUFFIX} \
