...
FINAL_IMAGE=${DISTDIR}/Assignment6.${IMAGE_TYPE}.${OUTPUT_SUFFIX}
else
...
SOURCEFILES_QUOTED_IF_SPACED=7SegWithKeyPad.asm

# Object Files Quoted if spaced
OBJECTFILES_QUOTED_IF_SPACED=${OBJECTDIR}/7SegWithKeyPad.o
POSSIBLE_DEPFILES=${OBJECTDIR}/7SegWithKeyPad.o.d

# Object Files
OBJECTFILES=${OBJECTDIR}/7SegWithKeyPad.o

# Source Files
SOURCEFILES=7SegWithKeyPad.asm
...
ifneq ($(INFORMATION_MESSAGE), )
	...
	${MAKE}  -f nbproject/Makefile-default.mk ${DISTDIR}/Assignment6.${IMAGE_TYPE}.${OUTPUT_SUFFIX}

MP_PROCESSOR_OPTION=PIC18F47K42
FINAL_IMAGE_NAME_MINUS_EXTENSION=${DISTDIR}/Assignment6.${IMAGE_TYPE}
# ------------------------------------------------------------------------------------
# Rules for buildStep: pic-as-assembler
ifeq ($(TYPE_IMAGE), DEBUG_RUN)
${OBJECTDIR}/7SegWithKeyPad.o: 7SegWithKeyPad.asm  nbproject/Makefile-${CND_CONF}.mk 
	@${MKDIR} "${OBJECTDIR}" 
	@${RM} ${OBJECTDIR}/7SegWithKeyPad.o 
	${MP_AS} -mcpu=PIC18F47K42 -c \
	-o ${OBJECTDIR}/7SegWithKeyPad.o \
	7SegWithKeyPad.asm \
...
ifeq ($(TYPE_IMAGE), DEBUG_RUN)
${DISTDIR}/Assignment6.${IMAGE_TYPE}.${OUTPUT_SUFFIX}: ${OBJECTFILES}  nbproject/Makefile-${CND_CONF}.mk    
	@${MKDIR} ${DISTDIR} 
	${MP_LD} -mcpu=PIC18F47K42 ${OBJECTFILES_QUOTED_IF_SPACED} \
	-o ${DISTDIR}/Assignment6.${IMAGE_TYPE}.${OUTPUT_SUFFIX} \
